  ...
  fields = {
    ...
    { config = {
        ...
        fields = {
          ...
          --{ exlude_log_body_content_type = { type = "string", default = "multipart/form-data", one_of = { "application/json", "multipart/form-data", "application/xml", "text/xml", "application/javascript", "text/javascript" }, }, },          
    }, }, },
  },
}
